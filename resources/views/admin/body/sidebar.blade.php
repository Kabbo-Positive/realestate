        ...
        <nav class="sidebar">
            ...
            <div class="sidebar-body">
              <ul class="nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#type_name" role="button" aria-expanded="false" aria-controls="emails">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Property Type</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                  </a>
                  <div class="collapse" id="type_name">
                ...
                @endif
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#property_state" role="button" aria-expanded="false" aria-controls="emails">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Property State</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                  </a>
                  <div class="collapse" id="property_state">
                    <ul class="nav sub-menu">
                      <li class="nav-item">
                ...
                <li class="nav-item">
                  ...
                  <div class="collapse" id="testimonials">
                    <ul class="nav sub-menu">
                      <li class="nav-item">
                        <a href="#" class="nav-link">Something-1</a>
                      </li>
                      <li class="nav-item">
                        <a href="#" class="nav-link">Something-2</a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#manage_agent" role="button" aria-expanded="false" aria-controls="emails">
                    <i class="link-icon" data-feather="mail"></i>
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#manage_agent" role="button" aria-expanded="false" aria-controls="uiComponents">
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#blog_category" role="button" aria-expanded="false" aria-controls="uiComponents">
                    <i class="link-icon" data-feather="feather"></i>
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#blog_post" role="button" aria-expanded="false" aria-controls="uiComponents">
                    <i class="link-icon" data-feather="feather"></i>
                ...
                <li class="nav-item">
                  <a class="nav-link" data-bs-toggle="collapse" href="#role_permission" role="button" aria-expanded="false" aria-controls="advancedUI">
