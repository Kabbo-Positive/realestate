                ...
                <div class="card-body">
                                  ...
                                  <form class="forms-sample" method="POST" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="exampleInputUsername1" value="{{ $profileData->name }}" autocomplete="off" placeholder="Name">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" id="exampleInputEmail1" value="{{ $profileData->email }}" placeholder="Email">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername1" class="form-label">Phone</label>
                                        <input type="text" class="form-control" name="phone" id="exampleInputUsername1" value="{{ $profileData->phone }}" autocomplete="off" placeholder="Phone">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleInputUsername1" class="form-label">Address</label>
                                        <input type="text" class="form-control" name="address" id="exampleInputUsername1" value="{{ $profileData->address }}" autocomplete="off" placeholder="Address">
                                    </div>
                                    <div class="mb-3">
