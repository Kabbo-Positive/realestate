                ...
                <div class="card-body">
                                  ...
                                  <form id="myForm" class="forms-sample" method="POST" action="{{ route('update.admin', $user->id) }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="username" id="username" value="{{ $user->username }}" autocomplete="off" placeholder="Admin User Name">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name" class="form-label">Admin Name</label>
                                        <input type="text" class="form-control" name="name" id="name" value="{{ $user->name }}" autocomplete="off" placeholder="Admin Name">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name" class="form-label">Admin Email</label>
                                        <input type="text" class="form-control" name="email" id="email" value="{{ $user->email }}" autocomplete="off" placeholder="Admin Email">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name" class="form-label">Admin Phone</label>
                                        <input type="text" class="form-control" name="phone" id="phone" value="{{ $user->phone }}" autocomplete="off" placeholder="Admin Phone">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name" class="form-label">Admin Address</label>
                                        <input type="text" class="form-control" name="address" id="address" value="{{ $user->address }}" autocomplete="off" placeholder="Admin Address">
                                    </div>

                                    {{-- <div class="form-group mb-3">
                                        <label for="name" class="form-label">Admin Password</label>
                                        <input type="password" class="form-control" name="password" id="password" value="{{ $user->password }}" autocomplete="off" placeholder="Admin Password">
                                    </div> --}}
