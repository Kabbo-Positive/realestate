      ...
      <table id="dataTableExample" class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('edit.permission', $item->id) }}" class="btn btn-inverse-warning"><i class="bi bi-pencil-square"></i></a>
                    <a href="{{ route('delete.permission', $item->id) }}" class="btn btn-inverse-danger" id="delete"><i class="bi bi-trash-fill"></i></a>
                </td>
              </tr>
            @endforeach
        </tbody>
